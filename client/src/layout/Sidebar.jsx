...
const Sidebar = ({ role = 'student' }) => {
    const menus = {
        ...
        faculty: [
            ...
            { replace: false, label: "Students", path: "/faculty/students", icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /> },
            ...
            { replace: false, label: "Approve NOCs", path: "/faculty/noc-approvals", icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /> },
        ],
        admin: [
            ...
            { replace: false, label: "Final Approve NOCs", path: "/admin/noc-approval", icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /> },
        ]
    };
