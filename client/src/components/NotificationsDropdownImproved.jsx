...
const NotificationsDropdownImproved = () => {
  ...
  // Clean outside click handling
  useEffect(() => {
    const handleClickOutside = (event) => {
      // Close if click is outside dropdown and not on the bell button
  ...
  }, [isOpen]); // Dependency on isOpen ensures proper cleanup
  ...
  const handleNotificationClick = (notification) => {
    ...
    setIsOpen(false); // Close after clicking notification
  };
...
export default NotificationsDropdownImproved;
